...
class BWFAN_WC_Product_Regular_Price extends BWFAN_Merge_Tag {
	...
	public function parse_shortcode( $attr ) {
		...
		$product_price = wc_price( BWFAN_Merge_Tag_Loader::get_data( 'product' )->get_regular_price() );
...
if ( bwfan_is_woocommerce_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_product', 'BWFAN_WC_Product_Regular_Price' );
}