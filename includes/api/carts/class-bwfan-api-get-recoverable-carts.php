...
class BWFAN_API_Get_Recoverable_Carts extends BWFAN_API_Base {
	...
	public function __construct() {
		...
		$this->request_args       = array(
			...
			'offset' => array(
				'description' => __( 'Recoverable carts list Offset', 'wp-marketing-automations-crm' ),
				'type'        => 'integer',
			),
			'limit'  => array(
	...
	public function process_api_call() {
		...
		$recoverable_carts = BWFAN_Recoverable_Carts::get_abandoned_carts( $bwfanc_search_by, $search_term, $offset, $limit );
