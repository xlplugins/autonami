            ...
            <td style="padding: 0;">
                <div class="bwfan-product-grid-container">
					<?php foreach ( $products as $product ) : ?>
                        <div class="bwfan-product-grid-item-3-col bwfan-reviews-grid__item" style="<?php echo( $n % 3 ? '' : 'margin-right: 0;' ); ?>">
                            ...
                            <a href="<?php echo esc_url_raw( $product->get_permalink() ); //phpcs:ignore WordPress.Security.EscapeOutput ?>#tab-reviews" class="autonami-button autonami-button--small"><?php echo apply_filters( 'bwfan_email_review_button_text', esc_html__( 'Leave a review', 'wp-marketing-automations' ) ); ?></a>
                        </div>
						<?php
						$n ++;
					endforeach;
